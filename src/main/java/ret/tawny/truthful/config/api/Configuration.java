...
public final class Configuration {
    ...
    public void setCheckEnabled(String checkType, String checkOrder, boolean enabled) {
    ...
    public boolean isCheckLagbackEnabled(String checkType, String checkOrder) {
        ...
        return isLagbacks() && isMovementType(CheckType.valueOf(checkType));
    }

    public int getCheckLagbackVl(String checkType, String checkOrder) {
        return this.config.getInt("checks." + checkType + "." + checkOrder + ".lagback.vl", 0);
    }
    ...
    public boolean isPunishmentEnabled(String checkType, String checkOrder) {
        return this.config.getBoolean("checks." + checkType + "." + checkOrder + ".punishment.enabled", false);
    }

    public void setPunishmentEnabled(String checkType, String checkOrder, boolean enabled) {
    ...
    public double getMinTps() { return this.config.getDouble("options.min-tps", 18.5); }
    ...
    public int getPingKickThreshold() { return this.config.getInt("latency-kicker.max-ping", 500); }
    ...
    public String getPluginDisplayName() { return this.config.getString("settings.plugin-name", "TruthfulAC"); }
    ...
    public int getDiscordMinVl() { return this.config.getInt("discord.min-vl", 5); }
    ...
    public void cleanupOrphanedChecks(java.util.Collection<ret.tawny.truthful.checks.api.Check> activeChecks) {
