...
public final class TransactionListener {
    ...
    public TransactionListener() {
        ProtocolLibrary.getProtocolManager().addPacketListener(new PacketAdapter(Truthful.getInstance().getPlugin(), ListenerPriority.HIGHEST,
    ...
    private void handleInTransaction(final PacketEvent transaction) {
        ...
        Truthful.getInstance().getDataManager().getPlayerData(player).setPing(transactionWrapper.accept()).setSynced(true);
    }
    ...
    public void handleRelMove(final Player player) throws InvocationTargetException {
        ...
        Truthful.getInstance().getDataManager().getPlayerData(player).setSynced(false);
    }
